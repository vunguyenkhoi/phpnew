...
<div class="row">
    ...
    <div class="row">
        <div class="col-xl-3 col-md-6">
            <!-- card -->
            <div class="card card-animate bg-custom-success bg-gradient ">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            <p class="text-uppercase fw-medium  text-white mb-0">Tổng số học sinh</p>
                        </div>
                    ...
                    <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                            <h4 class="fs-22 fw-semibold ff-secondary mb-4 text-white">$<span
                                    class="counter-value text-white" data-target="559.25">0</span>k</h4>
                            <a href="#" class="text-decoration-underline text-white">View net earnings</a>
                        </div>
        ...
        <div class="col-xl-3 col-md-6">
            ...
            <div class="card card-animate bg-info bg-gradient">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            <p class="text-uppercase fw-medium text-white mb-0">Học sinh mới</p>
                        </div>
                        <div class="flex-shrink-0">
                    ...
                    <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                            ...
                            <a href="#" class="text-decoration-underline text-white">View all orders</a>
                        </div>
                        <div class="avatar-sm flex-shrink-0">
        ...
        <div class="col-xl-3 col-md-6">
            <!-- card -->
            <div class="card card-animate bg-danger bg-gradient bg-opacity-85">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            <p class="text-uppercase fw-medium text-white mb-0">Học sinh đã nghỉ</p>
                        </div>
                        <div class="flex-shrink-0">
                            <h5 class="text-white fs-14 mb-0">
