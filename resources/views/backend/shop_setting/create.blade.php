                    ...
                    <div class="col-6">
                        <div>
                            ...
                            <input type="text" name="group" class=" form-control" id="group"
                                value="{{ old('group') }}" placeholder="Nhập tên nhóm">
                        </div>
                    </div>
                    <div class="col-6">
                        <div>
                            ...
                            <input type="text" name="key" class="form-control" id="key"
                                value="{{ old('key') }}" placeholder="Nhập vào tên khoá">
                        </div>
                    </div>
                    <div class="col-12">
                        <div>
                            ...
                            <input type="text" name="value" class="form-control" id="value"
                                value="{{ old('value') }}" placeholder="Nhập vào giá trị">
                        </div>
                    </div>
                    <div class="col-12">
                        <label for="description" class="form-label ">Mô tả </label>
                        <textarea name="description" class="form-control " id="description" placeholder="Nhập vào Diễn giải">{{ old('description') }}</textarea>
                    </div>
                </div>
                <div class="mt-3">
