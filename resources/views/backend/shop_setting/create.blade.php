...
<div class="card">
    ...
    <!-- end card header -->
    <div class="card-body">
        <form name="frmCreate" action="{{route('backend.shop_setting.store')}}" method="POST">
            @csrf @method('post')
            <div class="row gy-2">
                <div class="col-6">
                    <div>
                        <label for="group" class="form-label">Tên nhóm</label>
                        <input type="text" name="group" class=" form-control" id="group" placeholder="Nhập tên nhóm">
                ...
                <div class="col-6">
                    <div>
                        ...
                        <input type="text" name="key" class="form-control" id="key" placeholder="Nhập vào tên khoá">
                ...
                <div class="col-12">
                    <div>
                        ...
                        <input type="text" name="value" class="form-control" id="value" placeholder="Nhập vào giá trị">
