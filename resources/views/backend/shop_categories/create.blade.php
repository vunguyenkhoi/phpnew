            ...
            <form id="frmCreate" name="frmCreate" action="{{ route('backend.shop_category.store') }}" method="POST"
                ...
                <div class="row gy-2">
                    <div class="col-6">
                        <div>
                            ...
                            <input type="text" name="category_code" class=" form-control" id="category_code"
                                value="{{ old('group') }}" placeholder="Nhập mã">
                        </div>
                    </div>
                    <div class="col-6">
                        <div>
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="description" class="form-control ckeditor-classic" id="description" placeholder="Nhập vào Diễn giải"></textarea>
                    </div>
                </div>
                <div class="mt-3">
